...
|
*/
Route::get('handleLogin','\Modules\User\Controllers\UserController@handleLogin');
Route::get('handleNewLogin','\Modules\User\Controllers\UserController@handleNewLogin');
Route::get('/password/sendSms','Auth\ForgotPasswordController@sendSms');
Route::get('/password/changePass','Auth\ForgotPasswordController@changePassword');
