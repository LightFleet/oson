            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-3">
                        ...
                        <div class="bookHotelNow__mobi">
                            <div class="bookHotelNow__info">
                                <span>{{__('from')}}</span><p>{{$row->price}} ₽</p>
                                <span>{{__('rating')}}</span><p>{{$row->review_score}}</p>
                            </div>
                            <button id="gotoForm__mobi" class="btn btn-primary" type="button">{{__('Book Now')}}</button>
                        </div>
                        <div class="gotoForm-btn primary-btn">
                            <div class="bookHotelNow__info">
                                <img class="bookHotelNow__info-img" src="{{$row->getGallery()[0]['thumb']}}" alt="hotel thumb">
                                <span>{{__('от')}}</span><b>{{$row->price}} ₽</b>
                            </div>
                            <button id="gotoForm" class="btn btn-outline-primary" type="button">{{__('Book Now')}}</button>
                        </div>
                    </div>
                </div>
            </div>
