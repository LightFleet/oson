...
<div class="bravo-form-search-all" style="background-image: linear-gradient(0deg,rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('{{$bg_image_url}}') !important;margin-top: -106px;padding-top: 162px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
