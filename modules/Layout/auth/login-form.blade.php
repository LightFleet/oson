...
<form class="bravo-form-login" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="email" autocomplete="off" placeholder="{{__('Email address or phone')}}">
    ...
    <div class="form-group">
        <input type="button" value="{{ __('Login') }}" class="btn btn-primary form-ajax">
