...
<a href="mailto:contact@bookingcore.com">contact@bookingcore.com</a>',
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    ...
                    'val'   => "<p><span style=\"font-size: 14pt;\"><strong>OsonTravel</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
                                <p>https://oson.travel</p>",
                    'group' => "booking",
                ],
            ]);
    }
